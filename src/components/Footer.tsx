    ...
    <footer className="bg-white border-t border-gray-200 pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Cart&Go</h3>
            <p className="text-gray-600 mb-4">
              Fresh groceries delivered to your door. Fast, reliable, and always fresh.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-grocery-primary">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-600 hover:text-grocery-primary">Home</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/help" className="text-gray-600 hover:text-grocery-primary">Help Center</Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-600 hover:text-grocery-primary">FAQ</Link>
              </li>
              <li>
                <Link to="/shipping" className="text-gray-600 hover:text-grocery-primary">Shipping Policy</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-600 hover:text-grocery-primary">Contact Us</Link>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} Cart&Go Grocery. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
